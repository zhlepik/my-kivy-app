...
requirements = python3==3.11.9,hostpython3==3.11.9,kivy==2.3.0,kivymd==1.2.0,pyjnius,sdl2_ttf,sdl2_image,sdl2_mixer
...
#       [app]
#       title = TimePix # This is not a comment, it is part of the title.
#
